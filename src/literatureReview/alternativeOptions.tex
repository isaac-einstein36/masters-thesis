...
Following multiple unsuccessful powder-based extrusions, alternative device fabrication approaches were researched in the event that the initially proposed powder-based extrusion methodology could not be completed (see~\fullref{sec:discussion:extrudingPLCL:powderExtrusion}).
