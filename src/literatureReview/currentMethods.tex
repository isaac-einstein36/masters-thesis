...
Current devices and methods used for tumor bed (TB) delineation include titanium, gold, or liquid fiducial markers/surgical clips, surgeon discretion based on the lumpectomy scar, seroma formation, or implantable devices~\cite{RefWorks:RefID:25-acree2022review}.

Existing competitor devices and methods were researched to better understand the current state of technology and identify opportunities for improvement in the radiation therapy treatment planning process. These findings helped drive the design of the implantable device and influenced questions asked during end-user interviews (see~\fullref{sec:methodology:customerDiscovery}).
...
Seroma formation has also been used to mark the margins for radiation therapy. A seroma is a collection of clear fluids (serous and lymphatic) that gather subdermally where a tumor or tissue was resected~\cite{RefWorks:RefID:183-2023seroma, RefWorks:RefID:371-bakhtardesign}.
...
\begin{figure}[H]
        \centering
        \includegraphics[height=0.3\textwidth]{../figs/literature_review/currentMethods/seroma_contouring_guidelines.png}
...
\begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\textwidth]{../figs/literature_review/currentMethods/veraform_implant.png}
