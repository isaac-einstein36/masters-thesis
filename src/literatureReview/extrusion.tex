...
When performing the extrusion, the extrusion screw RPM, cooling fan speed, and spooler pull speed are also all important parameters that must be adjusted~\cite{RefWorks:RefID:393-3devo},~\cite{RefWorks:RefID:394-2024make}.
