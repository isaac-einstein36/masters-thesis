        ...
        \begin{adjustbox}{max width=\textwidth}
                \begin{threeparttable}
                        \begin{tabular}{l c c c c}
                                ...
                                PLA                                                                                                                                                    &
                                \begin{tabular}{@{}c@{}}3015 ± 86 MPa~\cite{RefWorks:RefID:133-staffa2022mechanical}\\3600 MPa~\cite{RefWorks:RefID:343-development}\end{tabular}      &
                                --                                                                                                                                                     &
                                3800 MPa (ID343)                                                                                                                                       &
                                \begin{tabular}{@{}c@{}}55.9 ± 6.5 MPa~\cite{RefWorks:RefID:133-staffa2022mechanical}\\50 MPa~\cite{RefWorks:RefID:343-development}\end{tabular}                                                                                                                                                                                                    \\
                                \hline
