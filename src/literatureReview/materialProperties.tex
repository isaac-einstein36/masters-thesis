...
Mechanical properties were evaluated throughout this research. Therefore, it is important to understand existing literature on mechanical properties of the materials being explored.

It was intended to test mechanical properties of PLCL filament, though 3D printing challenges prevented this (see~\fullref{sec:conclusion:futureWork:testingPLCL}).

Mechanical properties of PLA with barium sulfate, however, were evaluated to investigate the effects of barium sulfate concentration on material properties (see~\fullref{sec:methodology:effectsOfBaSO4})
