...
Barium sulfate was utilized as a radiopaque agent to provide adequate contrast during imaging. This was combined with PLA to create a radiopaque filament. This filament was 3D printed and tested for radiopacity (see~\fullref{sec:methodology:extrudingBaSO4},~\fullref{sec:methodology:3dPrintingBaSO4}, and~\fullref{sec:methodology:effectsOfBaSO4:imagingStudy}).
