...
3D printing was employed throughout this research to print and test samples of PLA with various concentrations of barium sulfate (see~\fullref{sec:methodology:3dPrintingBaSO4}). Various parameters such as build plate orientation and infill density were also researched to inform printing of samples for mechanical testing (see~\fullref{sec:methodology:effectsOfBaSO4:tensileTesting} and~\fullref{sec:methodology:effectsOfBaSO4:flexuralTesting}).
...
\begin{figure}[h!]
        ...
        \label{fig:literatureReview:printOrientation}
\end{figure}
