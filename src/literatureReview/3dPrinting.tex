...
Optimal starting printing parameters for materials used in this research, PLA, PCL, and PLCL, are provided in Table~\ref{tab:literatureReview:optimal_material_printing_parameters} as a reference point, though any new vendor or custom filament requires specific calibration.
...
\hl{Add section on optimal infill percentage}.
% Strength tradeoff with infill
% For tensile testing, 100% is closest to raw material as possible even though it uses a lot of material
% Look at undergrad thesis
