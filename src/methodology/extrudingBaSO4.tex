...
The overall goal of the research team is to incorporate barium sulfate (BaSO\textsubscript{4}) into PLCL via extrusion. Because PLCL extrusion is still being refined (see Section~\ref{sec:methodology:extrudingPLCL}), PLA was used as a base material for initial methodology testing and refinement. PLA is a standard material for extrusions, which allows for more streamlined research of barium sulfate affects by eliminating potential confounding variables.
...
Following guidance from 3Devo customer support, the samples were initially extruded at PLA presets - 170, 185, 190, 170 (\textcelsius) - and 4 RPM. If adjustments were necessary, 3Devo customer support suggested raising all heat zones by 5\textcelsius ~at a time to maintain the same temperature profile.

Results and discussion of the PLA/BaSO\textsubscript{4} extrusions can be found in Section.
