...
In this extrusion, the 3Devo Feeder was used for the first time. The temperature profile was started at PLA presets. All pellets were poured into the hopper with the Feeder running and the extrusion began.

Results and discussion of this extrusion can be found in ~\fullref{results:extrudingPLCL:pelletExtrusions:initialPelletExtrusion} and ~\fullref{sec:discussion:extrudingPLCL:pelletExtrusions:initialPelletExtrusion} respectively.
