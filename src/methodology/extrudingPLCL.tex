...
\subsubsection{Addressing Filament Thickness}
...
% Kept clogging when going from low H4 PLA/PCL to PLA. Was initially broken by running PLA. Discussion -> established need for routine purging.
...
\subsection{Purging Extruder\label{sec:methodology:extrudingPLCL:purgingExtruder}}
