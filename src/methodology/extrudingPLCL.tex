...
The team also explored injection molding as a means of combining the PLA and PCL pellets.
...
% show pictures of mixing pellets in a jar per Dr. Mulyana's suggestion.
% Used the feeder which ended up separating materials
% Still observed clumping which led to starve feeder development
% 3Devo reccomendations (see 6/2 meeting notes)
% Recommended to find extrudable temp of PCL
% melting can be because hopper is too hot (look into insulating or other pouring designs)
