...
% Tried adjusting H4 and RPM but thickness still too low
% Kept clogging when going from low H4 PLA/PCL to just PLA (ran with PLA to break clog, but a purge is ideal - that note can go in the purging).
% Tried regrinded PLCL
