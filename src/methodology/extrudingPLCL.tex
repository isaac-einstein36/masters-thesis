...
A large portion of the research in this thesis pertains to extruding PLCL into a 3D printable filament.


\subsection{General Timeline\label{sec:methodology:extrusion:timeline}}

See Section~\ref{sec:methodology:extrusion:combiningMaterials}

Also, see Section~\autoref{sec:methodology:extrusion:combiningMaterials}

Finally, see Section~\hyperref[sec:methodology:extrusion:timeline]{\ref*{sec:methodology:extrusion:timeline}~\nameref*{sec:methodology:extrusion:timeline}}.
