...
To design the GUI, ChatGPT and Claude.ai were utilized. This GUI was run in VSCode on the same computer used to connect to the extruder via DevoVision. Installation of pyserial was required to interact with the Arduino-based code. With this setup, one designated computer could be used for all aspects of extruding -- monitoring the extruder functionality and controlling the pellet dispensing into the extruder.

Additionally, the keypad and LCD could be removed from the system which substantially reduced clutter.
\hl{[Some of the above should go in discussion of the overall design of the starve feeder]}.
...
\hl{Section to explain how accuracy testing was performed (measuring Xg and weighing how close it was)}.
