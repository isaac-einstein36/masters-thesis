...
With the GUI in place, the keypad was removed from the system. The final Python-based code for the GUI can be found in ~\fullref{sec:appendix:pelletDispenserCode:Python}.
