...
This project was then adopted by a mechanical engineering senior capstone in 2022 (\hl{Check this date}). It has since been further explored by Adrian Bakhtar, Isaac Einstein, and Zuhaib Jama. The general contributions of each group or team member are summarized below in Table~\ref{tab:introduction:priorWorkCompletedOverview}.
