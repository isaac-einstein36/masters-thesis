...
Breast cancer is the second most deadly cancer for US women~\cite{RefWorks:RefID:36-american2021breast}. Breast cancer is a type of cancer that starts in one or both breasts. The left and right breast are each mainly glands, ducts, and fatty tissue, and breast cancer can start in these different parts of the breast or others~\cite{RefWorks:RefID:36-american2021breast}.
