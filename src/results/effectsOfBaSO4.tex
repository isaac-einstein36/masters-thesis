...
\begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\linewidth]{../figs/results/mechanicalTesting/tensileTesting/type_v_tensile_strength.png}
...
\begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\linewidth]{../figs/results/mechanicalTesting/flexuralTesting/flexural_testing_results.png}
