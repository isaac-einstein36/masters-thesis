...
"Good quality" filament output is determined through various quantitative and qualitative factors. A detailed explanation of these factors can be found in~\autoref{sec:literatureReview:extrusion:issues}.
...
Flat or non-circular filament can mean the output is not properly being cooled before being pushed through the filament sensor. This can require increased cooling or by increasing fan speed or slowing the output rate.
