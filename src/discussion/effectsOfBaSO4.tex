...
Based on these insights, it is possible that inaccuracies arose from the sample being too small for the machine which could have contributed to the unexpected insignificant affects of barium sulfate on tensile strength.
...
The results of the Type IV tensile testing did not appear to exhibit a pattern or show a direct effect of barium sulfate on tensile strength or elastic modulus. However, the results were within the proper order of magnitude as the custom-made 0\% BaSO$_4$ sample had a similar tensile strength to generic Bambu PLA.
...
Additionally, compared literature measured BaSO$_4$ concentrations across 0-25\% concentration, whereas this study looked more closely at 0-10\% as shown below in Figure~\ref{fig:discussion:effectsOfBaSO4:concentrationRanges}.

\begin{figure}[h!]
        \centering
        \includegraphics[width=\linewidth]{../figs/discussion/baSO4Extrusions/baSO4_range_in_thesis.png}
        \caption{Difference in BaSO$_4$ ranges between this thesis and existing literature~\cite{RefWorks:RefID:435-yang2015morphologies}.}
        \label{fig:discussion:effectsOfBaSO4:concentrationRanges}
\end{figure}

As a result of the increased resolution in this smaller range, it is possible that barium sulfate concentration has negligible effect on tensile properties in this smaller range. Additional testing with a larger sample size should be performed to confirm these findings.

\paragraph*{Key Takeaways}

The results of this experiment did not align with existing research which found an inverse relationship between barium sulfate concentration and tensile strength~\cite{RefWorks:RefID:32-amestoy2021crystallization,RefWorks:RefID:435-yang2015morphologies}. However, this testing suggests that barium sulfate concentration has a negligible impact on tensile properties between 0\% and 10\% as a relationship could not be determined.
...
The results of the flexural testing aligned with existing literature in that as barium sulfate concentration increased, the flexural modulus did as well~\cite{RefWorks:RefID:32-amestoy2021crystallization,RefWorks:RefID:435-yang2015morphologies}.

There was a clear visual direct relationship between barium sulfate concentration and flexural modulus. An increased flexural modulus means more force is required to bend a material, or that it is stiffer. This aligns with expected behavior of barium sulfate-incorporated materials.

This testing illustrates that minimal barium sulfate should be used to maintain the desired flexibility of the implant. If an implant is too stiff it may break under motion or resist motion and cause discomfort to the patient.
