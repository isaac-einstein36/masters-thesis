...
\title{Fabrication Methodology and Material Evaluation of a Radiopaque, Biodegradable Implant for Post-Lumpectomy Tumor Bed Delineation}
\authordegrees{B.S. Mechanical Engineering}  % Degrees thus far, not including this one.
...
{\compactspace{}
  \begin{small}
    ...
    \dedication{\em{To everyone touched by breast cancer, whose strength and stories shape the work behind these pages}}
