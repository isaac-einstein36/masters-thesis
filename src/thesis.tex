...
% \documentclass[masters,draft]{osudissert96}
\documentclass[masters]{osudissert96}
...
\title{\hl{(Title Subject to Change)}\\Fabrication Methodology and Material Evaluation of a Radiopaque, Biodegradable Implant for Post-Lumpectomy Tumor Bed Delineation}
\authordegrees{BS Mechanical Engineering}  % Degrees thus far, not including this one.
\unit{Mechanical Engineering}

\advisorname{Dr. Sandra Metzler}
\member{Dr. Carlos Castro}
% \member{YY}
% \member{ZZ}
...
{\compactspace{}
  \begin{small}
    ...
    \dedication{\emph{Dedicated to all associated with The Ohio State University}\\\hl{(Finish dedication)}}
...
\input{appendix/extrusionSummary/extrusionSummaryAppendix.tex}

\input{appendix/solidworksDrawings/solidworksDrawings.tex}

\input{appendix/starveFeederCode/starveFeederCode.tex}

\input{appendix/felfilGUICode/felfilGUICode.tex}

\input{appendix/interviewTemplates/interviewTemplates.tex}
